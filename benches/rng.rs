...
fill_bytes!(fill_bytes_splittable, SplittableRandom::new());
...
next_uint!(next_u32_splittable, u32, SplittableRandom::new());
...
next_uint!(next_u64_splittable, u64, SplittableRandom::new());
...
next_float!(next_f32_splittable, f32, SplittableRandom::new());
...
next_float!(next_f64_splittable, f64, SplittableRandom::new());
