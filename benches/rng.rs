...
fill_bytes!(fill_bytes_chacha8, ChaCha20::new());
fill_bytes!(fill_bytes_chacha12, ChaCha20::new());
...
init!(init_wyrand, Wyrand);
init!(init_chacha8, ChaCha8);
init!(init_chacha12, ChaCha12);
