...
// standard
distr_int!(standard_i8, i8, distr::Standard);
distr_int!(standard_i16, i16, distr::Standard);
distr_int!(standard_i32, i32, distr::Standard);
distr_int!(standard_i64, i64, distr::Standard);

distr_as_u32!(standard_bool, bool, distr::Standard);
distr_as_u32!(standard_alnum, char, distr::Alnum);
distr_as_u32!(standard_char, char, distr::Standard);

distr_float!(standard_f32, f32, distr::Standard);
distr_float!(standard_f64, f64, distr::Standard);
